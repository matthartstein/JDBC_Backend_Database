...
public class jdbc_db
{
   ...
   public void initDatabase() throws SQLException
   {
      ...
      //insert("STUDENT", "'010567629', 'Matt', 'Computer Science'");
      //insert("STUDENT", "'010855459', 'Sai', 'Computer Science'");

      //statement.executeUpdate("DELETE from COURSE");
      //insert("COURSE", "'CSCE', '4813', 'Computer Graphics', '3'");
      //insert("COURSE", "'CSCE', '4523', 'Database Management', '3'");
