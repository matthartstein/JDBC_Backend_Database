<html>
<body>
<h3>Add a Student to the Student Table:</h3>
...
<form action="function1.php" method="post">
    ...
    Major: <input type="text" name="city"><br>
...
if (isset($_POST['submit']))
{
    ...
    $command = ' java -cp .:mysql-connector-java-5.1.40-bin.jar function1 ' . $name . ' ' . $type . ' ' . $city;
